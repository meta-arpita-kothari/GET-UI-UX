...
// vehicle name
var vehicle_name = document.getElementById("vehicle-brand");
vehicle_name.addEventListener("keyup", function(e){
...
// vehicle number
var vehicle_number = document.getElementById("vehicle-number");
vehicle_number.addEventListener("keyup", function(e){
        if(e.key  == 'enter' || e.keyCode == 13){
...
employee_id.addEventListener("keyup", function(e){
        if(e.key  == 'enter' || e.keyCode == 13){
...
var vehicle_identification = document.getElementById("vehicle-identification");
vehicle_identification.addEventListener("keyup", function(e){
        if(e.key  == 'enter' || e.keyCode == 13){
...
function displayCurrency(obj , symbol){
    document.getElementById("daily-price").innerHTML = symbol+obj.daily;
    document.getElementById("monthly-price").innerHTML = symbol+ obj.monthly;
    document.getElementById("yearly-price").innerHTML = symbol+obj.yearly;
}
...
function displayPass(type,period, price){
    ...
    //price circle
    var price_circle = document.createElement('div');
...
//get pass
function getPass(){
    var period = this.event.target.classList.value;
